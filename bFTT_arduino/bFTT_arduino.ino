 ...
 *
 * IMU fusion code based on 
 * MPU9150_AHRS_directdata.ino
 * SFE_MPU9150 Library AHRS Data Fusion Example Code
 * Kris Winer for Sparkfun Electronics[ https://github.com/sparkfun/MPU-9150_Breakout ]
 */
...
void loop() {
  ...
  handLeft = analogRead(A1);
  handRight = analogRead(A2);
  ...
  Serial.print("#");
  Serial.print(handLeft);
  Serial.print("#");
  Serial.print(handRight);
  Serial.print("#");
